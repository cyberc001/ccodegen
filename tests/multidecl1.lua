...
function TestMultiDecl1:TestGlobalDeclTypes()
	lu.assertEquals(global_decls[1]._type, nodes.decl)
	lu.assertEquals(global_decls[2]._type, nodes.compound)
	lu.assertEquals(global_decls[3]._type, nodes.func)
	lu.assertEquals(global_decls[4]._type, nodes.enum_decl)
	lu.assertEquals(global_decls[5]._type, nodes.func)
	lu.assertEquals(global_decls[6]._type, nodes.enum_decl)
end

function TestMultiDecl1:TestStructs()
	local struct1 = global_decls[1].var_type
	...
	lu.assertTrue(is_node_assign_decl(global_decls[1]))
	local struct1name1 = global_decls[1].value[1].value[1]
	lu.assertEquals(struct1name1._type, nodes.var)
	struct1name1 = struct1name1.value
	lu.assertEquals(struct1name1.name, "vec_one")
	local struct1val1 = global_decls[1].value[1].value[2]
	...
	lu.assertEquals(struct1val1[1]._type, nodes.num)
	lu.assertEquals(struct1val1[1].value, 1)
	lu.assertEquals(struct1val1[2]._type, nodes.num)
	lu.assertEquals(struct1val1[2].value, 0)

	local struct2 = global_decls[2]
...
function TestMultiDecl1:TestFunctions()
	...
	lu.assertTrue(params1[2].var_type:has_mod("struct"))
	...
	lu.assertTrue(params2[1].var_type:has_mod("struct"))
