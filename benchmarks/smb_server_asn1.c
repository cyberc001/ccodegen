...
int build_spnego_ntlmssp_neg_blob(unsigned char **pbuffer, unsigned short *buflen,
...
int build_spnego_ntlmssp_auth_blob(unsigned char **pbuffer, unsigned short *buflen,
				   int neg_result)
{
	char *buf;
	unsigned int ofs = 0;
