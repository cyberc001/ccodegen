 ...
 */
static unsigned long long caches_show(struct kobject *kobj,
			   struct kobj_attribute *attr,
			   char *buf)
{
	unsigned long long n = 0, count = 0, limit = PAGE_SIZE;
...
static void v9fs_sysfs_cleanup()
{
 ...
 */
static int v9fs_init_inode_cache()
{
 ...
 *
 */
static void v9fs_destroy_inode_cache()
{
	/*
