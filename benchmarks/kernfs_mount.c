...
struct kmem_cache *kernfs_iattrs_cache;
...
static int kernfs_encode_fh(struct inode *inode, unsigned int *fh, int *max_len,
			    struct inode *parent)
{
					    ...
					    int fh_type, int get_parent)
{
	...
	case FILEID_INO32_GEN_PARENT:
		 ...
		 * blk_log_action().
		 */
		id = ((unsigned long long)fid->i32.gen << 32) | fid->i32.ino;
		break;
	default:
		return NULL;
	}
...
static void kernfs_mutex_init(void)
{
	int count;
...
static void kernfs_lock_init(void)
{
