...
static int tid_fd_mode(struct task_struct *task, unsigned fd, struct fmode_t *mode)
{
	struct file *file;
...
static struct dentry *proc_lookupfd_common(struct inode *dir,
					   ...
					   struct instantiate_t instantiate)
{
...
static int proc_readfd_count(struct inode *inode, long *count)
{
